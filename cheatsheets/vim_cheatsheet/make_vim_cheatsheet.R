...
nrm_676E_dsc = "jump back to the next match using the last used search pattern, skipping [count]-1 occurrences, if cursor is on a match visually select it"
nrm_674E_use = "[count]gN"
nrm_674E_dsc = "jump back to the next match using the last used search pattern, skipping [count]-1 occurrences, if cursor is on a match visually select it"
...
jmp_275E_use = "''"
jmp_275E_dsc = "jump to position before the latest jump, similar to <C-o>, but it works only once and goes to the start of the line rather than the exact location"
jmp_605E_use = "``"
jmp_605E_dsc = "jump to position before the latest jump, similar to <C-o>, but it works only once"
jmp_275E_use = "'["
jmp_275E_dsc = "jump to position before the latest jump, similar to <C-o>, but it works only once and goes to the start of the line rather than the exact location"
jmp_605E_use = "`["
jmp_605E_dsc = "jump to position before the latest jump, similar to <C-o>, but it works only once"
