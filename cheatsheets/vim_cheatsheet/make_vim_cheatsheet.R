...
y_norm_desc = "copy (yank) everything that [count] {motion} moves over"
yab_norm_use = "yab"
yab_norm_desc = "copy parentheses and everything inside"
yaB_norm_use = "yaB" 
yaB_norm_desc = "copy curly brackets and everything inside"
yaw_norm_use = "yaw"
yaw_norm_desc = "copy the entire word that the cursor is on and the adjacent space"
yaW_norm_use = "yaW"
yaW_norm_desc = "copy the entire WORD that the cursor is on"
ya_sqbrack_norm_use = "ya["
ya_sqbrack_norm_desc = "copy square brackets and everything inside"
ya_singleq_norm_use = "ya'"
ya_singleq_norm_desc = "copy single quotes and everything inside"
ya_doubleq_norm_use = 'ya"'
ya_doubleq_norm_desc = "copy double quotes and everything inside"
yy_norm_use = "[count]yy"
yy_norm_desc = "copy [count] lines"
yib_use = "yib or yi("
yib_desc = "copy everything inside parentheses"
yiB_norm_use = "yiB or yi{"
yiB_norm_desc = "copy everything inside curly brackets"
yiw_norm_use = "yiw"
yiw_norm_desc = "copy the inner word that the cursor is on"
yiW_norm_use = "yiW"
yiW_norm_desc = "copy the inner WORD that the cursor is on"
yi_sqbrack_norm_use = "yi["
yi_sqbrack_norm_desc = "copy everything inside square brackets"
yi_singleq_norm_use = "yi'"
yi_singleq_norm_desc = "copy everything inside single quotes"
yi_doubleq_norm_use = 'yi"'
yi_doubleq_norm_desc = "copy everything inside double quotes"
ygn_norm_use = "[count]ygn"
ygn_norm_desc = "copy the next match using the last used search pattern, skipping [count]-1 occurrences"
ygN_norm_use = "[count]ygN"
ygN_norm_desc = "copy the previous match using the last used search pattern, skipping [count]-1 occurrences"
yn_norm_use = "[count]yn"
yn_norm_desc = "copy from cursor to next match using the last used search pattern, skipping [count]-1 occurrences"
yN_norm_use = "[count]yN"
yN_norm_desc = "copy from cursor to previous match using the last used search pattern, skipping [count]-1 occurrences"
yf_use = "y[count]f{char} or [count]yf{char}"
yf_desc = "copy everything from the cursor up to and including {char}, skipping [count]-1 occurrences"
yF_use = "y[count]F{char} or [count]yF{char}"
yF_desc = "copy everything from the cursor back to and including {char}, skipping [count]-1 occurrences"
yt_use = "y[count]t{char} or [count]yt{char}"
yt_desc = "copy everything from the cursor up to {char}, skipping [count]-1 occurrences"
yT_use = "y[count]T{char} or [count]yT{char}"
yT_desc = "copy everything from the cursor back to {char}"
#Y
Y_norm_use = "[count]Y"
Y_norm_desc = "copy [count] lines"
#z
zb_norm_use = "[count]zb"
zb_norm_desc = "scroll so that the cursor line is at the bottom"
zt_norm_use = "[count]zt"
zt_norm_desc = "scroll so that the cursor line is at the top"
zz_norm_use = "[count]zz"
zz_norm_desc = "scroll so that the cursor line is at the middle"
z_dot_norm_use = "[count]z."
z_dot_norm_desc = "scroll so that the cursor line is at the middle, move cursor to first non-blank character"
z_return_norm_use = "[count]z<CR>"
z_return_norm_desc = "scroll so that the cursor line is at the top, move cursor to first non-blank character"
z_dash_norm_use = "[count]z-"
z_dash_norm_desc = "scroll so that the cursor line is at the bottom, move cursor to first non-blank character"
#Z
Z_norm_use = "[count]Z"
