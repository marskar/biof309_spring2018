...
nrm_dg6E_dsc = "delete the next match using the last used search pattern, skipping [count]-1 occurrences"
nrm_dg4E_use = "[count]dgN"
nrm_dg4E_dsc = "delete the previous match using the last used search pattern, skipping [count]-1 occurrences"
...
#o
nrm_o_use = "[count]o"
nrm_o_dsc = "insert [count] lines below current line"
#O
nrm_O_use = "[count]O"
nrm_O_dsc = "insert [count] lines above current line"
#p
nrm_p_use = "[count]p"
nrm_p_dsc = "paste character(s) to right of cursor or line(s) below current line, [count] times"
#P
nrm_P_use = "[count]P"
nrm_P_dsc = "paste character(s) to left of cursor or line(s) above current line, [count] times"
#q
nrm_q_use = 'q{0-9a-zA-Z"}'
nrm_q_dsc = 'Record typed characters into register {0-9a-zA-Z"}'
#r
...
#y
 = "[count]y{motion}"
 = "copy (yank) everything that [count] {motion} moves over"
nrm_ya62_use = "yab"
...
nrm_z_dot_use = "[count]z."
nrm_z_dot_dsc = "scroll so that the cursor line is at the middle, move cursor to first non-blank character"
nrm_returnrm_use = "[count]z<CR>"
nrm_returnrm_dsc = "scroll so that the cursor line is at the top, move cursor to first non-blank character"
nrm_z_dash_use = "[count]z-"
nrm_z_dash_dsc = "scroll so that the cursor line is at the bottom, move cursor to first non-blank character"
#Z
nrm_Z_use = "[count]Z"
