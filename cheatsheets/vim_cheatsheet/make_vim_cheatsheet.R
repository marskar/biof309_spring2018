...
ins_0F_use = "<C-c>"
ins_0F_dsc = "return to Normal mode"
ins_08_use = "<C-h>"
...
ins_12_use = "<C-n>"
ins_12_dsc = "autocomplete based on anything the comes up next in the current file"
ins_12_use = "<C-p>"
ins_12_dsc = "autocomplete based on anything the came up previously in the current file"
ins_08_use = "<C-u>"
ins_08_dsc = "delete current line"
ins_08_use = "<C-w>"
ins_08_dsc = "delete back one word"
ins_1B_use = "<C-o>"
ins_1B_dsc = "return to Normal mode"
...
jmp_27_use = "'{mark}"
jmp_27_dsc = "jump to {mark}"
jmp_60_use = "`{mark}"
jmp_60_dsc = "jump to {mark}"
jmp_27_use = "'{mark}"
jmp_27_dsc = "jump to {mark}"
jmp_60_use = "`{mark}"
jmp_60_dsc = "jump to {mark}"
